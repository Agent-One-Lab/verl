...
python3 -m verl.trainer.main_ppo \
    ...
    agent.init_args.tools=$tools \
    agent.init_args.template=$template \
    agent.init_args.model_name_or_path=$model \
    agent.init_args.backend=${agent_backend} \
    agent.init_args.reward_name=$reward_name \
