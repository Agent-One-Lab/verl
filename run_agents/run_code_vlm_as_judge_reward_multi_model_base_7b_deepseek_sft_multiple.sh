...
model=${MODEL:-/mnt/weka/shrd/ad/haonan.li/ViPhy/new_models/deepseek-r1-distill-qwen-7b_sft-multiple}
## Todo: add template
...
experiment_name=${EXPERIMENT_NAME:-vlm_as_judge_reward_multi_model_base_7b_deepseek_sft_multiple}
